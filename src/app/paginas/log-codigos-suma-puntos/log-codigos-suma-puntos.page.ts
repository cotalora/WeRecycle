...
@Component({
  selector: 'app-log-codigos-suma-puntos',
  templateUrl: './log-codigos-suma-puntos.page.html',
  styleUrls: ['./log-codigos-suma-puntos.page.scss'],
})
export class LogCodigosSumaPuntosPage implements OnInit {
