...
@Component({
  ...
  templateUrl: './administrador-detalle.page.html',
  styleUrls: ['./administrador-detalle.page.scss'],
})
export class AdministradorDetallePage implements OnInit {
  ...
  async tryUpdate(){
    ...
    if(this.pApellido == "") {
      ...
      if (this.correoAux != this.correo) {
        ...
        return new Promise(resolve => {
          let body = {
            aksi: 'proses_update_administrador',
            id: this.id,
