...
@Component({
  selector: 'app-log-administrativo-crud',
  templateUrl: './log-administrativo-crud.page.html',
  styleUrls: ['./log-administrativo-crud.page.scss'],
})
export class LogAdministrativoCrudPage implements OnInit {
